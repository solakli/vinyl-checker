...
async function fetchWantlist(username, userHeaders) {
    var headers = userHeaders || discogsHeaders();
    return new Promise(function (resolve, reject) {
        var fetchPage = function (page, allWants) {
            ...
            https.get({
                ...
                if (res.statusCode === 403) return reject(new Error('Wantlist is private. Ask ' + username + ' to make their wantlist public on Discogs (Settings → Privacy → Wantlist → Public)'));
