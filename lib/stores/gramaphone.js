...
// ── Matching: delegated to shared matchInventoryRow() in scrapers.js ──────────
// checkGramaphone() calls s.matchInventoryRow(item, row) directly, which uses
// the catno-first, stricter-threshold logic shared with Further and Octopus.
