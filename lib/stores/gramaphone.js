...
// Try the structured artist/title match first, then fall back to combined
// matching against the original Shopify title (which sometimes has format
// info appended like "(180g reissue)" that we want the existing matchers
// to tolerate).
