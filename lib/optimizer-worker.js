    ...
    return {
        cart: optimizerResult.cart.map(function (c) {
            return {
                ...
                isPinned: !!c.source.isPinned,
                shippingCostUsd: c.shippingCostUsd,
                shippingSource: c.source.shippingSource || 'estimate', // 'actual'|'estimate'
...
async function processJob(job) {
    ...
    var pinnedSellers   = Array.isArray(params.pinnedSellers) ? params.pinnedSellers : [];
