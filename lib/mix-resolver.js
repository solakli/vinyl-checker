...
function parseScIdAnswers(commentObjs) {
    ...
    const NOISE = /^(?:any\s|did\s|still\s|nope|yeah|nah|thx|thanks|lol|haha|omg|wow|me\s|us\s|same|crazy|sick|fire|love|great|amazing|nice|beautiful|incredible|wait|found\s|looking|manage|nothing|no[\s,!]+|nah\b|@.{1,25}(?:any\s|did\s|still\s|luck|found|looking|manage|nothing))/i;
