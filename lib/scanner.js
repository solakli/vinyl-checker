    ...
    try {
        ...
        for (var u = 0; u < users.length; u++) {
            ...
            for (var i = 0; i < items.length; i++) {
                ...
                // Yield to the event loop every 50 items to keep HTTP responsive.
                // The catalog checkers use synchronous SQLite which blocks the event
                // loop — without this yield, a 23-user / ~500-item average catalog
                // match would block for 30-60 seconds and make the server appear down.
                if (totalItems % 50 === 0) await new Promise(function(r) { setImmediate(r); });
            }
        }
