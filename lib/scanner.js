...
// On Linux/server: use more workers for speed. On macOS locally, 1 worker avoids
// Chrome page crashes caused by too many simultaneous tabs.
const IS_MAC        = process.platform === 'darwin';
const NUM_WORKERS   = IS_MAC ? 1 : 3;  // manual scans
const DAILY_WORKERS = IS_MAC ? 1 : 2;  // daily rescan
