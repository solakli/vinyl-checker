...
// On Linux/server: 2 workers (was 3, reduced to avoid OOM). On macOS: 1 worker avoids
// Chrome page crashes caused by too many simultaneous tabs.
const IS_MAC        = process.platform === 'darwin';
const NUM_WORKERS   = IS_MAC ? 1 : 2;  // manual scans: 2 on server, 1 on macOS
const DAILY_WORKERS = 1;               // daily rescan: 1 worker always (was 2, caused OOM)
